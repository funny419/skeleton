...
public class Entities {
    ...
    private static final String[][] APOS_SET = {{ "apos","39" }};

    private static final String[][] ISO_8859_1_SET = {
            { "nbsp","160" },// non-breaking
    ...
    private final Map<String,Integer> entityNameToValue = CollectionUtil.createHashMap();
    private final IntHashMap<String> entityValueToName = new IntHashMap<String>();
